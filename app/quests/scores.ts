...
const KEY = "letter-quest-scores";
const COLOR_KEY = "letter-quest-color";
...
export function getSelectedColor(): string {
  if (typeof window === "undefined") return BOOK_COLORS[0].color;
  return localStorage.getItem(COLOR_KEY) || BOOK_COLORS[0].color;
}
